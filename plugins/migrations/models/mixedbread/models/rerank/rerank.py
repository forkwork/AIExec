...
import httpx
from aiexec_plugin.entities.model import AIModelEntity, FetchFrom, I18nObject, ModelPropertyKey, ModelType
...
from aiexec_plugin.interfaces.model.rerank import RerankModel
    ...
    def _invoke(
        ...
        try:
            ...
            for result in results["data"]:
                rerank_document = RerankDocument(index=result["index"], text=result["input"], score=result["score"])
