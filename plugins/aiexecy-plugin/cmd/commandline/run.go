...
import (
	"aiexec-plugin/cmd/commandline/run"
	"github.com/spf13/cobra"
)

/*
 Test is a very important component of Aiexec plugins, to ensure every plugin is working as expected
 ...
 It makes things easier, the command should be `run`, instead of `test`, user could use `aiexec plugin run <plugin_id>`
