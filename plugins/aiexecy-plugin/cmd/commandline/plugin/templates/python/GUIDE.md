## User Guide of how to develop a Aiexec Plugin
...
- `REMOTE_INSTALL_URL`: The URL of debugging host and port of plugin-daemon service from your Aiexec instance, eg. `debug.aiexec.ai:5003`. Either the [Aiexec SaaS](https://debug.aiexec.ai) or [self-hosted Aiexec instance](https://docs.aiexec.ai/en/getting-started/install-self-hosted/readme) can be used.
...
To streamline your plugin update workflow, you can configure GitHub Actions to automatically create PRs to the Aiexec plugin repository whenever you create a release.

##### Prerequisites

- Your plugin source repository
- A fork of the aiexec-plugins repository
...
For detailed setup instructions and example configuration, visit: [GitHub Actions Workflow Documentation](https://docs.aiexec.ai/plugins/publish-plugins/plugin-auto-publish-pr)
