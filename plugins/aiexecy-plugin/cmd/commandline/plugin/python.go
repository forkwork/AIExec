...
import (
	...
	"aiexec-plugin/internal/utils/strings"
...
//go:embed templates/python/.aiexecignore
var PYTHON_AIEXECIGNORE []byte
...
func createPythonEnvironment(
	...
	if err := writeFile(filepath.Join(root, ".aiexecignore"), string(PYTHON_AIEXECIGNORE)); err != nil {
		return err
	}
