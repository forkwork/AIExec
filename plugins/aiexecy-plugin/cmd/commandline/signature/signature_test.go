...
//go:embed testdata/dummy_plugin.aiexecpkg
...
func TestSignAndVerify(t *testing.T) {
	...
	dummyPluginPath := filepath.Join(tempDir, "dummy_plugin.aiexecpkg")
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			testPluginPath := filepath.Join(tempDir, "test_plugin_"+tt.name+".aiexecpkg")
...
// TestVerifyUnsigned tests verification of an unsigned aiexecpkg file
...
// TestVerifyTampered tests verification of a tampered signed aiexecpkg file
func TestVerifyTampered(t *testing.T) {
	...
	tamperedPluginPath := filepath.Join(tempDir, "tampered_plugin.signed.aiexecpkg")
