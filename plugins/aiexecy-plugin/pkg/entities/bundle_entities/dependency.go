...
type GithubDependency struct {
	...
	// 1. owner/repo/1.0.0/aaa.aiexecpkg
	// 2. owner/repo/1.0.0/*.aiexecpkg
	// 3. owner/repo/1.x.x/aaa.aiexecpkg
	// 4. owner/repo/^1.0.0/aaa.aiexecpkg
	// 5. owner/repo/~1.0.0/aaa.aiexecpkg
	// 6. owner/repo/1.0.0-2.0.0/aaa.aiexecpkg
	// 7. owner/repo/1.0.0-beta/aaa.aiexecpkg
...
type PackageDependency struct {
	// refers to the path of aiexecpkg file in assets
