...
type PluginMeta struct {
	...
	MinimumAiexecVersion *string          `json:"minimum_aiexec_version" yaml:"minimum_aiexec_version"`
}
...
type PluginDeclarationWithoutAdvancedFields struct {
	...
	Type        manifest_entities.AiexecManifestType `json:"type" yaml:"type,omitempty" validate:"required,eq=plugin"`
