...
import (
	...
	"aiexec-plugin/pkg/bundle_packager"
	"aiexec-plugin/pkg/entities"
	"aiexec-plugin/pkg/entities/bundle_entities"
...
func UploadPluginPkg(
	...
	c *gin.Context,
	tenant_id string,
	aiexec_pkg_file multipart.File,
	verify_signature bool,
) *entities.Response {
	pluginFile, err := io.ReadAll(aiexec_pkg_file)
	if err != nil {
...
func UploadPluginBundle(
	...
	c *gin.Context,
	tenant_id string,
	aiexec_bundle_file multipart.File,
	verify_signature bool,
) *entities.Response {
	bundleFile, err := io.ReadAll(aiexec_bundle_file)
	if err != nil {
		return exception.InternalServerError(err).ToResponse()
	}
