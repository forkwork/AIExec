...
type Config struct {
	...
	// aiexec inner api
	AiexecInnerApiURL string `envconfig:"AIEXEC_INNER_API_URL" validate:"required"`
	AiexecInnerApiKey string `envconfig:"AIEXEC_INNER_API_KEY" validate:"required"`
	...
	AiexecInvocationConnectionIdleTimeout int `envconfig:"AIEXEC_INVOCATION_CONNECTION_IDLE_TIMEOUT" validate:"required"`

	AiexecPluginServerlessConnectorURL           *string `envconfig:"AIEXEC_PLUGIN_SERVERLESS_CONNECTOR_URL"`
	AiexecPluginServerlessConnectorAPIKey        *string `envconfig:"AIEXEC_PLUGIN_SERVERLESS_CONNECTOR_API_KEY"`
	AiexecPluginServerlessConnectorLaunchTimeout int     `envconfig:"AIEXEC_PLUGIN_SERVERLESS_CONNECTOR_LAUNCH_TIMEOUT"`
	...
	// aiexec invocation write timeout in milliseconds
	AiexecInvocationWriteTimeout int64 `envconfig:"AIEXEC_BACKWARDS_INVOCATION_WRITE_TIMEOUT" default:"5000"`
	// aiexec invocation read timeout in milliseconds
	AiexecInvocationReadTimeout int64 `envconfig:"AIEXEC_BACKWARDS_INVOCATION_READ_TIMEOUT" default:"240000"`
}
...
func (c *Config) Validate() error {
	...
	if c.Platform == PLATFORM_SERVERLESS {
		if c.AiexecPluginServerlessConnectorURL == nil {
			return fmt.Errorf("aiexec plugin serverless connector url is empty")
		}

		if c.AiexecPluginServerlessConnectorAPIKey == nil {
			return fmt.Errorf("aiexec plugin serverless connector api key is empty")
		}
