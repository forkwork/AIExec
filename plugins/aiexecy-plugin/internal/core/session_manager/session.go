...
type Session struct {
	...
	backwardsInvocation aiexec_invocation.BackwardsInvocation `json:"-"`
...
type NewSessionPayload struct {
	...
	Action                 access_types.PluginAccessAction        `json:"action"`
	Declaration            *plugin_entities.PluginDeclaration     `json:"declaration"`
	BackwardsInvocation    aiexec_invocation.BackwardsInvocation    `json:"backwards_invocation"`
...
func (s *Session) BindBackwardsInvocation(backwardsInvocation aiexec_invocation.BackwardsInvocation) {
	s.backwardsInvocation = backwardsInvocation
}

func (s *Session) BackwardsInvocation() aiexec_invocation.BackwardsInvocation {
