...
from aiexec_plugin.interfaces.model.openai_compatible.llm import (
...
class OpenAILargeLanguageModel(OAICompatLargeLanguageModel):
    def get_customizable_model_schema(
        ...
        if structured_output_support == "supported":
            # ----
            # The following section should be added after the new version of `aiexec-plugin-sdks`
            # is released.
            # Related Commit:
            # https://github.com/khulnasoft/aiexec-plugin-sdks/commit/0690573a879caf43f92494bf411f45a1835d96f6
            # ----
            # try:
