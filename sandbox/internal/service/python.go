...
func RunPython3Code(code string, preload string, options *runner_types.RunnerOptions) *types.AiexecSandboxResponse {
...
func ListPython3Dependencies() *types.AiexecSandboxResponse {
...
func RefreshPython3Dependencies() *types.AiexecSandboxResponse {
...
func UpdateDependencies() *types.AiexecSandboxResponse {
