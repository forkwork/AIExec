...
from aiexec_plugin.core.server.serverless.response_writer import ServerlessResponseWriter
...
class ServerlessRequestReader(RequestReader):
    ...
    def _run(self):
        ...
        if socket.socket is gevent.socket.socket:
            ...
            print("* Serving Flask app 'aiexec_plugin.core.server.serverless.request_reader'")
