...
from aiexec_plugin.core.utils.http_parser import parse_raw_request
from aiexec_plugin.entities.agent import AgentRuntime
from aiexec_plugin.entities.tool import ToolRuntime
...
class PluginExecutor:
    def __init__(self, config: AiexecPluginEnv, registration: PluginRegistration) -> None:
        self.config = config
