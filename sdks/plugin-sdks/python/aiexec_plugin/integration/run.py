...
from aiexec_plugin.integration.entities import PluginGenericResponse, PluginInvokeRequest, ResponseType
from aiexec_plugin.integration.exc import PluginStoppedError
...
class PluginRunner:
    ...
    with PluginRunner(
        ...
        plugin_package_path="./khulnasoft-agent_0.0.14.aiexecpkg",
    ) as runner:
    ...
    def __init__(self, config: IntegrationConfig, plugin_package_path: str, extra_args: list[str] | None = None):
        ...
        self.process = subprocess.Popen(  # noqa: S603
            [config.aiexec_cli_path, "plugin", "run", plugin_package_path, "--response-format", "json", *self.extra_args],
