...
from aiexec_plugin.entities.model import EmbeddingInputType, ModelPropertyKey, ModelType
from aiexec_plugin.entities.model.text_embedding import TextEmbeddingResult
