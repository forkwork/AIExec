...
from aiexec_plugin.entities.model import ModelFeature
...
from aiexec_plugin.entities.tool import LogMetadata, ToolInvokeMessage, ToolProviderType
from aiexec_plugin.interfaces.agent import AgentModelConfig, AgentStrategy, ToolEntity, ToolInvokeMeta
