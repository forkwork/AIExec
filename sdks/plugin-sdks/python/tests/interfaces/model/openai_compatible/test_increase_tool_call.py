...
from aiexec_plugin.interfaces.model.openai_compatible.llm import _increase_tool_call
...
def test__increase_tool_call():
    ...
    with patch("aiexec_plugin.interfaces.model.openai_compatible.llm._gen_tool_call_id", mock_id_generator):
