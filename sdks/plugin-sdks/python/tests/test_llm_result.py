from aiexec_plugin.entities.model.llm import LLMResult, LLMResultChunk, LLMResultChunkDelta, LLMUsage
from aiexec_plugin.entities.model.message import AssistantPromptMessage, TextPromptMessageContent
...
def test_build_llm_result_chunk_with_prompt_messages():
    ...
    """
    NOTE:
    - https://github.com/khulnasoft/aiexec/issues/17799
    - https://github.com/khulnasoft/aiexec-official-plugins/issues/648
