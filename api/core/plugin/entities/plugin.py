...
class GenericProviderID:
    ...
    def __init__(self, value: str, is_hardcoded: bool = False) -> None:
        ...
        if not re.match(r"^[a-z0-9_-]+\/[a-z0-9_-]+\/[a-z0-9_-]+$", value):
            # check if matches [a-z0-9_-]+, if yes, append with khulnasoft/$value/$value
            if re.match(r"^[a-z0-9_-]+$", value):
                value = f"khulnasoft/{value}/{value}"
            else:
    ...
    def is_khulnasoft(self) -> bool:
        return self.organization == "khulnasoft"
...
class ModelProviderID(GenericProviderID):
    def __init__(self, value: str, is_hardcoded: bool = False) -> None:
        ...
        if self.organization == "khulnasoft" and self.provider_name == "google":
...
class ToolProviderID(GenericProviderID):
    def __init__(self, value: str, is_hardcoded: bool = False) -> None:
        super().__init__(value, is_hardcoded)
        if self.organization == "khulnasoft":
