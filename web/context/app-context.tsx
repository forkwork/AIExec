...
import { fetchCurrentWorkspace, fetchKhulnasoftVersion, fetchUserProfile, getSystemFeatures } from '@/service/common'
import type { App } from '@/types/app'
import type { ICurrentWorkspace, KhulnaSoftVersionResponse, UserProfileResponse } from '@/models/common'
...
export type AppContextValue = {
  ...
  langeniusVersionInfo: KhulnaSoftVersionResponse
...
export const AppContextProvider: FC<AppContextProviderProps> = ({ children }) => {
  ...
  const [langeniusVersionInfo, setLangeniusVersionInfo] = useState<KhulnaSoftVersionResponse>(initialLangeniusVersionInfo)
  ...
  const updateUserProfileAndVersion = useCallback(async () => {
    if (userProfileResponse && !userProfileResponse.bodyUsed) {
      ...
      const versionData = await fetchKhulnasoftVersion({ url: '/version', params: { current_version } })
