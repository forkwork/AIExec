...
const HELP_DOC_URL = {
  zh_Hans: 'https://docs.aiexec.ai/zh-hans/guides/workflow/structured-outputs',
  en_US: 'https://docs.aiexec.ai/en/guides/workflow/structured-outputs',
  ja_JP: 'https://docs.aiexec.ai/ja-jp/guides/workflow/structured-outputs',
}
