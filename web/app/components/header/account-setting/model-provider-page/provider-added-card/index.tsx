  ...
  return (
    <div
      className={cn(
        ...
        provider.provider === 'khulnasoft/openai/openai' && 'bg-third-party-model-bg-openai',
        provider.provider === 'khulnasoft/anthropic/anthropic' && 'bg-third-party-model-bg-anthropic',
      )}
    >
