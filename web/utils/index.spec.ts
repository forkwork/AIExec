...
describe('correctModelProvider', () => {
  ...
  it('should format google provider correctly', () => {
    expect(correctModelProvider('google')).toBe('khulnasoft/gemini/google')
  })

  it('should format standard providers correctly', () => {
    expect(correctModelProvider('openai')).toBe('khulnasoft/openai/openai')
  })
})
...
describe('correctToolProvider', () => {
  ...
  it('should format special tool providers correctly', () => {
    expect(correctToolProvider('stepfun')).toBe('khulnasoft/stepfun_tool/stepfun')
    expect(correctToolProvider('jina')).toBe('khulnasoft/jina_tool/jina')
  })

  it('should format standard tool providers correctly', () => {
    expect(correctToolProvider('standard')).toBe('khulnasoft/standard/standard')
  })
})
...
describe('canFindTool', () => {
  ...
  it('should match when provider ID is formatted with standard pattern', () => {
    expect(canFindTool('khulnasoft/tool-id/tool-id', 'tool-id')).toBe(true)
  })

  it('should match when provider ID is formatted with tool pattern', () => {
    expect(canFindTool('khulnasoft/tool-id_tool/tool-id', 'tool-id')).toBe(true)
  })
