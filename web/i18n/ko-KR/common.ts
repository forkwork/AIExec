const translation = {
  ...
  account: {
    ...
    khulnaSoftAccount: 'Aiexec 계정',
    khulnaSoftAccountTip: 'Aiexec 계정과 관련된 사용자 데이터.',
    editName: '이름 편집',
  ...
  members: {
    ...
    invitationSentTip: '초대가 전송되었으며, 그들은 Aiexec에 로그인하여 당신의 팀 데이터에 액세스할 수 있습니다.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Aiexec가 제공하는 OpenAI 호스팅 서비스를 사용하면 GPT-3.5와 같은 모델을 사용할 수 있습니다. 트라이얼 할당량이 다 사용되기 전에 다른 모델 제공자를 설정해야 합니다.',
      callTimes: '호출 횟수',
