const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'Aiexecへようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、Aiexec Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'Aiexecへのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの Aiexec Enterprise ライセンスの有効期限が切れています。Aiexecを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Aiexec Enterprise ライセンスが非アクティブです。Aiexecを引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'Aiexecライセンスサーバーへの接続に失敗しました。続けてAiexecを使用するために管理者に連絡してください。',
}
