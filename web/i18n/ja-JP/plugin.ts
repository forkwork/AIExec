const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    aiexecMarketplace: 'Aiexecマーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインはAiexecによって認証されています',
    partnerTip: 'このプラグインはAiexecのパートナーによって認証されています',
  },
  task: {
  ...
  aiexecVersionNotCompatible: '現在のAiexecバージョンはこのプラグインと互換性がありません。最小バージョンは{{minimalAiexecVersion}}です。',
  metadata: {
    title: 'プラグイン',
  },
}
