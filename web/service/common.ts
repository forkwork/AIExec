...
export const fetchKhulnasoftVersion: Fetcher<KhulnaSoftVersionResponse, { url: string; params: Record<string, any> }> = ({ url, params }) => {
  return get<KhulnaSoftVersionResponse>(url, { params })
}
